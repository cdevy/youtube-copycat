...
public class UploadVideo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Credential credential = Authentification.authorize(scopes, "uploadvideo");

            // This object is used to make YouTube Data API requests.
            youtube = new YouTube.Builder(Authentification.HTTP_TRANSPORT, Authentification.JSON_FACTORY, credential).setApplicationName(
