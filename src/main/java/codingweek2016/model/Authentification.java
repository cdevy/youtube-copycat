...
public class Authentification {
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore) throws IOException {
    	// Load client secrets.
        Reader cSReader = new InputStreamReader(Authentification.class.getResourceAsStream("/client_secrets.json"));
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, cSReader);
